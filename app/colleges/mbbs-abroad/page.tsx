    ...
    <div className="min-h-screen bg-background font-body">
      ...
      <section className="he-section">
        <div className="he-container">
          ...
          <div className="sticky top-[6.5rem] z-30 mb-6 rounded-[16px] border border-border bg-white/95 p-3 shadow-[0_8px_28px_rgba(15,23,42,0.06)] backdrop-blur-md sm:p-4">
            <CollegeFilterBar
              className="mb-0"
              search={search}
              onSearchChange={(v) => {
